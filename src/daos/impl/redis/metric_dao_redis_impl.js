...
const insertMetric = async (siteId, metricValue, metricName, timestamp) => {
  ...
  const metricKey = keyGenerator.getDayMetricKey(siteId, metricName, timestamp); // este es un key de un sorted set. necesito agregar un metric value a este sorted set
